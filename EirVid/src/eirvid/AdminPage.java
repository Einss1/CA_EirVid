        ...
        do {
            ...
            switch (input) {
                ...
                case 1:
                    ...
                    /* Sets SQL max connections to 5000 */
                    try {
                        st = My_CNX.getConnection().prepareStatement("SET GLOBAL max_connections = 5000"); /* https://stackoverflow.com/questions/19822558/how-to-set-max-connections-in-mysql-programmatically */
                        st.executeUpdate();
                        System.out.println("Max connections set!");
                    } catch (SQLException err) {
                        System.out.println("Something went wrong while setting max connections");
                    }
                    ...
                    /* Insert into new database movies and their prices. */
                    try {
